...
x_input = st.slider("Choose X input", min_value=0.0, max_value=5.0,key='x')
y_input = st.slider("Choose Y input", min_value=0.0, max_value=5.0,key='y')
k = st.slider("Choose value of K", min_value=1, max_value=9,key='k')
